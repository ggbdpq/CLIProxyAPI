...
| [config.yaml](vscode-webview://086md48o61jrftk1b66eg255ijimphep3pmjtk5pmheevj3crmgv/cpa-manage-tools/config.yaml) | 本地运行配置（当前端口 **8318**）                            |
...
| [config.example.yaml](vscode-webview://086md48o61jrftk1b66eg255ijimphep3pmjtk5pmheevj3crmgv/cpa-manage-tools/config.example.yaml) | **默认端口改为 8318**、auth-dir 相对路径、fill-first 策略 |
