...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/data-records", func(c *gin.Context) { s.dataRecordsStore().ListDataRecords(c) })
		mgmt.GET("/data-records/batches", func(c *gin.Context) { s.dataRecordsStore().ListDataRecordBatches(c) })
		mgmt.GET("/data-records/stats", func(c *gin.Context) { s.dataRecordsStore().StatsDataRecords(c) })
		mgmt.POST("/data-records/update-state", func(c *gin.Context) { s.dataRecordsStore().UpdateDataRecordState(c) })
		mgmt.POST("/data-records/update-batch", func(c *gin.Context) { s.dataRecordsStore().UpdateDataRecordBatch(c) })
